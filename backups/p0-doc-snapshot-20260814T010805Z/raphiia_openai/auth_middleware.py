...
TOOL_SCOPES = {
    ...
    "invoke_agent": "ralfia:write",
    "ralfia_dispatch": "ralfia:write",
    "ralfia_status": "ralfia:read",
    "dispatch_local_agent": "ralfia:write",
    "run_self_heal_cycle": "ralfia:write",
    "run_service_guardian": "ralfia:read",
    "agent_quote_prepare": "ralfia:write",
    "agent_report_technical": "ralfia:write",
    "agent_invoice_prepare": "ralfia:write",
    ...
    "get_email_security_status": "ralfia:read",
    "list_email_actions": "ralfia:read",
    "list_captured_email_documents": "ralfia:read",
    "get_email_capture_summary": "ralfia:read",
    "confirm_email_routing": "ralfia:write",
    "backfill_inbox_reviews": "ralfia:write",
    "get_accounting_ledger_status": "ralfia:read",
    "sync_accounting_ledger_from_contifico": "ralfia:write",
    "search_accounting_ledger": "ralfia:read",
    "get_accounting_ledger_monthly": "ralfia:read",
    "sync_full_accounting_pipeline": "ralfia:write",
    "run_daily_contifico_pipeline": "ralfia:write",
    "import_contifico_incremental": "ralfia:write",
    "link_fac_to_cot_quotes": "ralfia:write",
    "sync_inventory_from_contifico": "ralfia:write",
    "peek_next_contifico_invoice_number": "ralfia:read",
    ...
    "save_owner_credential": ["ralfia:memory:write", "ralfia:private_memory"],
    "get_owner_credential": ["ralfia:memory:read", "ralfia:private_memory"],
    "list_owner_credentials": ["ralfia:memory:read", "ralfia:private_memory"],
    "get_owner_vault_summary": ["ralfia:memory:read", "ralfia:private_memory"],
    "import_owner_credentials_from_email": ["ralfia:memory:write", "ralfia:private_memory"],
