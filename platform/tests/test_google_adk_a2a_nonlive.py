...
class RemoteA2aAgentContractTests(unittest.TestCase):
    def test_existing_agent_cards_are_adk_sub_agents(self) -> None:
        ...
        cards = a2a_bridge.agent_cards()["cards"]
    ...
    def test_integration_sub_agent_reuses_existing_a2a_bridge_dry_run(self) -> None:
        result = google_adk_a2a.dispatch_remote_sub_agent(
            None,
        ...
        self.assertEqual(result["a2a_task_id"], result["task"]["a2a_task_id"])
