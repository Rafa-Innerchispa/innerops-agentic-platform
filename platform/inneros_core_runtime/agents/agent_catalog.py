...
AGENT_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "AG-57": _entry("DMX Stage Orchestrator", "Orquestador de iluminación escénica DMX512 / Art-Net, cabezas móviles pulpos, beams y efectos", domain="home", entry_tool="invoke_agent", aliases=["dmx", "artnet", "pulpos", "luces disco", "iluminacion dmx", "stage lights"], intent_keywords=["dmx", "artnet", "luces dmx", "pulpos", "beams", "tachos", "bola disco", "fiesta", "arcoiris", "strobe", "morado uv", "blacklight"]),
}
