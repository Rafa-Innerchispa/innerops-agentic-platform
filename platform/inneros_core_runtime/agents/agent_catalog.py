...
# AG-32 network/UniFi/alarm capability extension.
...
_AG32_ALARM_ALIASES = ["alarma", "alarm", "intelbras", "interbras", "anm 24 net", "amt24 net"]
_AG32_ALARM_INTENTS = ["alarma", "alarm", "intelbras", "interbras", "anm 24", "amt24", "sirena", "pánico", "panico", "seguridad casa"]
AGENT_CATALOG["AG-32"]["role"] = "Casa inteligente, Home Assistant, UniFi/Wi-Fi, alarma Intelbras, Hubitat, Broadlink y domótica unificada"
AGENT_CATALOG["AG-32"]["aliases"] = sorted(set((AGENT_CATALOG["AG-32"].get("aliases") or []) + _AG32_NETWORK_ALIASES + _AG32_ALARM_ALIASES))
AGENT_CATALOG["AG-32"]["intent_keywords"] = list(dict.fromkeys((AGENT_CATALOG["AG-32"].get("intent_keywords") or []) + _AG32_NETWORK_INTENTS + _AG32_ALARM_INTENTS))
