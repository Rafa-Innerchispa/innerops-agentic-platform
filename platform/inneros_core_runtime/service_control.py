...
CONFIG_RESTART_MAP: dict[str, list[dict[str, str]]] = {
    ...
    "LINKEDIN_PERSONAL_CLIENT_ID": [{"unit": "ralfia-app.service", "scope": "user"}],
    "LINKEDIN_PERSONAL_CLIENT_SECRET": [{"unit": "ralfia-app.service", "scope": "user"}],
    "LINKEDIN_ORG_CLIENT_ID": [{"unit": "ralfia-app.service", "scope": "user"}],
    "LINKEDIN_ORG_CLIENT_SECRET": [{"unit": "ralfia-app.service", "scope": "user"}],
