...
@mcp.tool
def dev_swarm_scheduler_recovery_tick(
    limit: int = 6,
    dry_run: bool = False,
    task_ids: list[str] | None = None,
) -> dict[str, Any]:
    """Recovery lane: re-admite ops blocked con dev_swarm_retry_requested sin depender del scheduler global."""
    from raphiia_openai import dev_swarm_recovery

    return dev_swarm_recovery.scheduler_recovery_tick(limit=limit, dry_run=dry_run, task_ids=task_ids)
