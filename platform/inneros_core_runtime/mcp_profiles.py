...
PROFILES: dict[str, dict[str, Any]] = {
    ...
    "notion_operator": {
        "label": "Notion operator — sync + supervised agent execution",
        "model_minimum": "medium",
        "max_tools": 47,
        "tools": [
            "mcp_version",
        ...
        "denied_by_policy": [
            "ralfia:admin",
            "raw shell and Local Execution Plane mutation tools",
            "secret access",
            "destructive/cloud/production apply without explicit owner approval",
        ],
    },
    "notion_team": {
        "label": "Notion team agent — coordinación, conocimiento y desarrollo local seguro",
        "model_minimum": "medium",
        "max_tools": 96,
        "tools": [
            "mcp_version",
        ...
        "denied_by_policy": [
            ...
            "raw shell",
            "production deploy without owner approval window",
        ],
    },
    "local_self_repair": {
